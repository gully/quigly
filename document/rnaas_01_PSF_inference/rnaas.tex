...
\begin{enumerate}
  ...
  \item Each PSF component has 5 parameters-- relative $(x, y)$ location; amplitude; and covariance matrix parameters $(\phi_1, \phi_2, \phi_3)$.
